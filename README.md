...
A GPU é **obrigatória nas Aulas 2 e 3** — a Aula 2 treina uma ResNet34 e a Aula 3 roda Faster R-CNN
e Mask R-CNN; nenhuma das duas termina em tempo razoável na CPU. Nas Aulas 1 e 4 ela é opcional:
as redes são pequenas e rodam na CPU sem incômodo.
